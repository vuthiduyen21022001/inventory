...
namespace HQSOFT.eBiz.Inventor.Data;

public class InventorTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<InventorTenantDatabaseMigrationHandler> _logger;

    public InventorTenantDatabaseMigrationHandler(
        IDbContextProvider<AuthServerHostMigrationsDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<InventorTenantDatabaseMigrationHandler> logger)
    {
