 ...
 * - HQSOFT.eBiz.Inventor.AuthServer
 * - HQSOFT.eBiz.Inventor.Web.Unified (used as linked file)
 */
public class InventorSampleIdentityDataSeeder : ITransientDependency
{
    ...
    public InventorSampleIdentityDataSeeder(
