...
using HQSOFT.eBiz.Inventor.Blazor.WebAssembly;
...
[DependsOn(
    ...
    typeof(InventorBlazorWebAssemblyModule)
)]
public class InventorBlazorHostModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(InventorBlazorHostModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new InventorHostMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add("Inventor");
        });
    }
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<InventorBlazorHostModule>();
        });
    }
}
